...
type Service struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Resource      *Service_Endpoint      `protobuf:"bytes,1,opt,name=resource,proto3" json:"resource,omitempty"`
...
func (x *Service) GetResource() *Service_Endpoint {
	if x != nil {
		return x.Resource
	}
	return nil
...
func (x *Service_Endpoint) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\x95\x01\n" +
	"\aService\x128\n" +
	"\bresource\x18\x01 \x01(\v2\x1c.kratos.api.Service.EndpointR\bresource\x120\n" +
	"\x04user\x18\x02 \x01(\v2\x1c.kratos.api.Service.EndpointR\x04user\x1a\x1e\n" +
	"\bEndpoint\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addrB\x18Z\x16bff/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Service_Endpoint)(nil),    // 8: kratos.api.Service.Endpoint
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Service.resource:type_name -> kratos.api.Service.Endpoint
	8,  // 8: kratos.api.Service.user:type_name -> kratos.api.Service.Endpoint
